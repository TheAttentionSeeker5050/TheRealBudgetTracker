...
class SummaryMonthView(MonthArchiveView):
    """We only show the summary for the current month"""
    ...
    # def get_context_data(self, **kwargs):
    #     context = super(SummaryMonthView, self).get_context_data(**kwargs)
    #     context.update({'income': self.total_income, 'expense': self.total_expense, "balance": self.balance})
    #     return context
