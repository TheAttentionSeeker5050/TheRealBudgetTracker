...
function get_url_month_and_year() {
  ...
  const inc_year_month_array = get_url_month_and_year() // returns an array with position 0 as year and position 1 as month
  
  // now we fetch data from our url
  
  var url = `http://127.0.0.1:8000/api/entries/${inc_year_month_array[0]}/${inc_year_month_array[1]}/`
